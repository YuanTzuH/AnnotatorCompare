...
```{r}
df_ClinVar_GRCh38_PLP_vep_refseq <- tsv_query %>%
  select(
...
# 只留NM, NR, NC Tx
```{r}
df_ClinVar_GRCh38_PLP_vep_refseq <- df_ClinVar_GRCh38_PLP_vep_refseq %>%
...
```{r}
save(df_ClinVar_GRCh38_PLP_vep_refseq, file = "GRCh38_PLP/df_ClinVar_GRCh38_PLP_vep_refseq.RData")
```
...
df_ClinVar_GRCh38_PLP_vep_refseq %>%
  ...
  write_tsv("GRCh38_PLP/case20240819.tsv")
```
