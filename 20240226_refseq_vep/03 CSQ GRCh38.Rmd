...
```{r}
CSQ_ClinVar_GRCh38_BLB_vep_refseq <- df_ClinVar_GRCh38_BLB_vep_refseq %>%
  mutate(
...
```{r}
save(CSQ_ClinVar_GRCh38_BLB_vep_refseq, file = "CSQ_concordance/CSQ_ClinVar_GRCh38_BLB_vep_refseq.RData")
```


```{r}
CSQ_ClinVar_GRCh38_PLP_vep_refseq <- df_ClinVar_GRCh38_PLP_vep_refseq %>%
  mutate(
    Consequence = case_when(
...
```{r}
save(CSQ_ClinVar_GRCh38_PLP_vep_refseq, file = "CSQ_concordance/CSQ_ClinVar_GRCh38_PLP_vep_refseq.RData")
```
