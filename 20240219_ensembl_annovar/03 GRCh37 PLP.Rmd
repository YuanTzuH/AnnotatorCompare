...
```{bash}
head GRCh37_PLP/ClinVar_GRCh37_PLP.ensGene.variant_function
```

```{r}
tsv_all_variant <- read_tsv(
  "GRCh37_PLP/ClinVar_GRCh37_PLP.ensGene.variant_function",
...
```{bash}
head GRCh37_PLP/ClinVar_GRCh37_PLP.ensGene.exonic_variant_function
```

```{r}
tsv_exon_variant <- read_tsv(
  "GRCh37_PLP/ClinVar_GRCh37_PLP.ensGene.exonic_variant_function",
...
```{r}
df_ClinVar_GRCh37_PLP_annovar_ensembl <- bind_rows(
...
```{r}
df_ClinVar_GRCh37_PLP_annovar_ensembl[df_ClinVar_GRCh37_PLP_annovar_ensembl == ""] = "."
df_ClinVar_GRCh37_PLP_annovar_ensembl[is.na(df_ClinVar_GRCh37_PLP_annovar_ensembl)] = "."
```
...
```{r}
save(df_ClinVar_GRCh37_PLP_annovar_ensembl, file = "GRCh37_PLP/df_ClinVar_GRCh37_PLP_annovar_ensembl.RData")
```
