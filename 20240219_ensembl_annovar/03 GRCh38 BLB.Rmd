...
```{bash}
head GRCh38_BLB/ClinVar_GRCh38_BLB.ensGene.variant_function
```
...
```
 ...
 [7] "ncRNA_exonic"   "ncRNA_intronic" "splicing"       "ncRNA_splicing"
...
```{bash}
head GRCh38_BLB/ClinVar_GRCh38_BLB.ensGene.exonic_variant_function
```
...
```{r}
df_ClinVar_GRCh38_BLB_annovar_ensembl <- bind_rows(
...
```{r}
df_ClinVar_GRCh38_BLB_annovar_ensembl[df_ClinVar_GRCh38_BLB_annovar_ensembl == ""] = "."
df_ClinVar_GRCh38_BLB_annovar_ensembl[is.na(df_ClinVar_GRCh38_BLB_annovar_ensembl)] = "."
```
...
```{r}
save(df_ClinVar_GRCh38_BLB_annovar_ensembl, file = "GRCh38_BLB/df_ClinVar_GRCh38_BLB_annovar_ensembl.RData")
```
