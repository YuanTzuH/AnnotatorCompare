...
```{r}
CSQ_ClinVar_GRCh38_BLB_vep_ensembl <- df_ClinVar_GRCh38_BLB_vep_ensembl %>%
  mutate(
...
```{r}
save(CSQ_ClinVar_GRCh38_BLB_vep_ensembl, file = "CSQ_concordance/CSQ_ClinVar_GRCh38_BLB_vep_ensembl.RData")
```


```{r}
CSQ_ClinVar_GRCh38_PLP_vep_ensembl <- df_ClinVar_GRCh38_PLP_vep_ensembl %>%
  mutate(
    Consequence = case_when(
...
```{r}
save(CSQ_ClinVar_GRCh38_PLP_vep_ensembl, file = "CSQ_concordance/CSQ_ClinVar_GRCh38_PLP_vep_ensembl.RData")
```
