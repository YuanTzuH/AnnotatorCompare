...
```{r}
df_ClinVar_GRCh38_BLB_snpeff_ensembl <- tsv_ann_sep2 %>%
  select(
...
# 濾掉怪Feature_ID
```{r}
df_ClinVar_GRCh38_BLB_snpeff_ensembl <- df_ClinVar_GRCh38_BLB_snpeff_ensembl %>%
...
```{r}
save(df_ClinVar_GRCh38_BLB_snpeff_ensembl, file = "GRCh38_BLB/df_ClinVar_GRCh38_BLB_snpeff_ensembl.RData")
```
