...
```{r}
df_ClinVar_GRCh37_PLP_snpeff_ensembl <- tsv_ann_sep2 %>%
  select(
...
# 濾掉怪Feature_ID
```{r}
df_ClinVar_GRCh37_PLP_snpeff_ensembl <- df_ClinVar_GRCh37_PLP_snpeff_ensembl %>%
...
```{r}
save(df_ClinVar_GRCh37_PLP_snpeff_ensembl, file = "GRCh37_PLP/df_ClinVar_GRCh37_PLP_snpeff_ensembl.RData")
```
