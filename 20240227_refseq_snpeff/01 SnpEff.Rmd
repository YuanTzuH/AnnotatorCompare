...
OUTPUD_DIR=/volume/rproj/Paper3Annot_2024/ClinVar20240107/20240227_refseq_snpeff
...
java -Xmx10g -jar snpEff.jar GRCh37.p13 $SnpEff_INPUT_VCF > $SnpEff_OUTPUT_VCF
...
cd /volume/rproj/Paper3Annot_2024/ClinVar20240107/20240227_refseq_snpeff
...
```{bash}
wc -l GRCh38_PLP/ClinVar_GRCh38_PLP_Tx1_20240107.query.tsv
```

```{bash}
wc -l GRCh38_BLB/ClinVar_GRCh38_BLB_Tx1_20240107.query.tsv
```
