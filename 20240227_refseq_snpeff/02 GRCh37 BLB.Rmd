...
```{r}
df_ClinVar_GRCh37_BLB_snpeff_refseq <- tsv_ann_sep2 %>%
  select(
...
# 濾掉怪Feature_ID
```{r}
df_ClinVar_GRCh37_BLB_snpeff_refseq <- df_ClinVar_GRCh37_BLB_snpeff_refseq %>%
...
```{r}
save(df_ClinVar_GRCh37_BLB_snpeff_refseq, file = "GRCh37_BLB/df_ClinVar_GRCh37_BLB_snpeff_refseq.RData")
```
