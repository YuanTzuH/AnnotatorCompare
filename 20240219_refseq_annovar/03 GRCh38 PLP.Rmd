...
```{bash}
head GRCh38_PLP/ClinVar_GRCh38_PLP.refGene.variant_function
```
...
```{bash}
head GRCh38_PLP/ClinVar_GRCh38_PLP.refGene.exonic_variant_function
```
...
```{r}
df_ClinVar_GRCh38_PLP_annovar_refseq <- bind_rows(
...
```{r}
df_ClinVar_GRCh38_PLP_annovar_refseq[df_ClinVar_GRCh38_PLP_annovar_refseq == ""] = "."
df_ClinVar_GRCh38_PLP_annovar_refseq[is.na(df_ClinVar_GRCh38_PLP_annovar_refseq)] = "."
```
...
```{r}
save(df_ClinVar_GRCh38_PLP_annovar_refseq, file = "GRCh38_PLP/df_ClinVar_GRCh38_PLP_annovar_refseq.RData")
```
