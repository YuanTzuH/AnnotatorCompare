...
OUT_DIR=/volume/rproj/Paper3Annot_2024/ClinVar20240107/20240326_ensembl_annovar_PaperCase

perl table_annovar.pl $IN_avinput \
humandb/ --buildver hg38 --protocol ensGene --operation g -polish \
-out $OUT_DIR/PaperCase_GRCh38_ensembl \
--thread 1 \
...
perl table_annovar.pl $IN_avinput \
humandb/ --buildver hg19 --protocol ensGene --operation g -polish \
-out $OUT_DIR/PaperCase_GRCh19_ensembl \
--thread 1 \
--argument '--neargene 5000 --hgvs --transcript_function --separate' \
--dot2underline --nastring .
